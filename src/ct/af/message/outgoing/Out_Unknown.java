...
public class Out_Unknown {
	...
	public EquinoxRawData messageBuilder(AbstractAF abstractAF,EC02Instance ec02Instance,AFSubInstance afSubIns) {
		...
		Map<String, String> map = new HashMap<String, String>();
			map.put(EEqxMsg.METHOD.getEqxMsg(), afSubIns.getSubInitMethod());
		...
		strbuilder.append("<vcrr>"
				+ "<res>322</res>"
				+ "<desc>INGateway Send HTTP Incomplete Data Response</desc>"
				+ "</vcrr>");
		...
		//-- Stats --//
		//afSubIns.setStatsOut(EStats.INGATEWAY_RECEIVE_UNKNOWN_REQUEST);
