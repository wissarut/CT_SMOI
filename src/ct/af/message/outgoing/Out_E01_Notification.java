...
public class Out_E01_Notification {
	...
	public EquinoxRawData messageBuilder(AbstractAF abstractAF,EC02Instance ec02Instance,AFSubInstance afSubIns) {
		...
		KeyObject keyObj = new KeyObject(e01Object,new String[] {"000",channel,"success","def","def"});
		...
		//-- Stats --//
		afSubIns.addStatsOut(EStats.INGATEWAY_SEND_E01_QUERY_NOTIFICATION_REQUEST);
