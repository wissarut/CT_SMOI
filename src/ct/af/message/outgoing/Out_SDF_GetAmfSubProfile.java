...
public class Out_SDF_GetAmfSubProfile {
	...
	public EquinoxRawData messageBuilder(AbstractAF abstractAF,EC02Instance ec02Instance,AFSubInstance afSubIns) {
		...
		Map<String, String> map = new HashMap<String, String>();
			map.put("method", "GET");
			map.put(EEqxMsg.URL.getEqxMsg(), "/v1/amf/MSISDN/"+afSubIns.getSubMSISDN()+"/subdata/amfProfile.json");
		...
		//-- Stats --//
		afSubIns.addStatsOut(EStats.INGATEWAY_SEND_SDF_GET_AMFSUBPROFILE_REQUEST);
