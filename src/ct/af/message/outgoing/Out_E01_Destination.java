...
import org.joda.time.DateTime;import ct.af.enums.EProtocal;
...
public class Out_E01_Destination {
	...
	public EquinoxRawData messageBuilder(AbstractAF abstractAF,EC02Instance ec02Instance,AFSubInstance afSubIns) {
		...
		String e01Object = "Destination";
		KeyObject keyObj = new KeyObject(e01Object,new String[] {"0",ec02Instance.getAFInstance().getMainLocation(),"def","def","def"});
		...
		//-- Stats --//
		afSubIns.addStatsOut(EStats.INGATEWAY_SEND_E01_QUERY_DESTINATION_REQUEST);
