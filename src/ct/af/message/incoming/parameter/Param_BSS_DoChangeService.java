...
public class Param_BSS_DoChangeService {
	...
	@Path("Body/do_ChangeServiceResponse/sResult")
	...
	@ElementList(entry = "SProductOrderResultList_Item",inline = true)
	@Path("Body/do_ChangeServiceResponse/SProductOrderResultList")
	private List<SProductOrderResultList_Item> sProductOrderResultListItem;
	public List<SProductOrderResultList_Item> getSProductOrderResultListItem() {
		return sProductOrderResultListItem;
	}
}
