...
public class TestDebug10 extends Testamentor {
...
//		testCaseList.add("SDF_GetAmfSubProfile.xml");
//		testCaseList.add("SDF_GetAmfCounter.xml");
//		testCaseList.add("SDF_GetSidRatingElement.xml");
//		testCaseList.add("SDF_GetSidNotificationElement.xml");
//		//DispPPSInfo RBTS
//		testCaseList.add("Client_dispPPSInfo.xml");
//		testCaseList.add("DS2A_inquirySubscriber.xml");
////		testCaseList.add("SGSCP_SMOI_ForwardCommand.xml");
//		testCaseList.add("SGSCP_SMOI_ForwardCommand_Timeout.xml");
//		
//		
//		//2.DispPPSPkgrew BOS
...
//		testCaseList.add("Client_modiScrScreenType.xml");
//		testCaseList.add("DS2A_inquirySubscriber.xml");
//		testCaseList.add("BMP_callScreeßning.xml");
...
//		testCaseList.add("BOS_mainBalanceAccountAdjustment.xml");
//		//setPPSReward BSS
//		testCaseList.add("Client_setPPSlance.xml");		
//		//setPPSReward INS
...
//		//20.firstAct RBTS
//		testCaseList.add("1-Client-Request.xml");
//		testCaseList.add("2-DS2A-Response.xml");
//		testCaseList.add("SGSCP_SMOI_ForwardCommand.xml");
